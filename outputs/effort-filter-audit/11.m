...
shared #"IMPORT Demand Workbook" = Excel.Workbook(Binary.Buffer(File.Contents(Unit1Path & "\2. Calculations\Demand.xlsx")), null, true);
...
shared #"IMPORT Capacity Workbook" = Excel.Workbook(Binary.Buffer(File.Contents(Unit1Path & "\2. Calculations\Capacity.xlsx")), null, true);
...
// Purpose: Import Allocation.xlsx once for both allocation-table extractions.
shared #"IMPORT Allocation Workbook" = Excel.Workbook(Binary.Buffer(File.Contents(Unit1Path & "\2. Calculations\Allocation.xlsx")), null, true);
...
shared #"EXTRACT Allocation" = let
    Source = #"IMPORT Allocation Workbook",
...
// Purpose: Preserve the existing legacy query interface without another workbook read.
shared #"IMPORT Allocation" = #"EXTRACT Allocation";

// Query: IMPORT Settings Data
// Purpose: Import Settings Data.xlsx once for all existing and contract-reporting settings.
shared #"IMPORT Settings Data" = Excel.Workbook(Binary.Buffer(File.Contents(Unit1Path & "\2. Calculations\Settings Data.xlsx")), null, true);
...
// Purpose: Preserve the existing scalar query interface without another Settings Data read.
...
shared #"IMPORT StaffListMaster" = Excel.Workbook(Binary.Buffer(File.Contents(Unit1Path & "\2. Calculations\StaffListMaster.xlsx")), null, true);
...
// Purpose: Preserve the former duplicate interface while reusing the consolidated Capacity import.
...
// Purpose: Preserve the former visible mapping interface without a second external workbook read.
