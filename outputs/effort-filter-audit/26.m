...
shared ResShiftAllocation = let
    ...
    #"Filtered RES NULL +UNIT2##" = Table.SelectRows(#"Renamed Columns", each ([Resource] <> null) )
in
    #"Filtered RES NULL +UNIT2##";
...
shared #"Availabilities Appended#" = let
    ...
    #"Filtered UNIT2#" = Table.SelectRows(#"Sorted Rows", each ([Facility] = "Unit1"))
in
    #"Filtered UNIT2#";
