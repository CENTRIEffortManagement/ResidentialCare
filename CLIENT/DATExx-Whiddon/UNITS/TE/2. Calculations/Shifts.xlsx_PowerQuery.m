// Power Query from: Shifts.xlsx
// Pathname: c:\Users\Alex\CentriNOTSYNC\ResidentialCare\CLIENT\DATExx-Whiddon\UNITS\TE\2. Calculations\Shifts.xlsx
// Extracted: 2026-09-24T08:43:00.784Z
...
shared #"LINK Role Analysis" = let
    ...
    #"Removed Other Columns1" = Table.SelectColumns(#"Filtered Rows",{"Roles"}),
    #"Renamed Columns" = Table.RenameColumns(#"Removed Other Columns1",{{"Roles", "ROLES"}})
in
    #"Renamed Columns";
