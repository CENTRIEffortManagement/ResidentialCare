...
// Pathname: c:\Users\Alex\CentriNOTSYNC\ResidentialCare\CLIENT\DATExx-Whiddon\UNITS\TE\2. Calculations\Intervals.xlsx
// Extracted: 2026-09-24T08:43:11.727Z
...
shared #"LINK RoleAnalysis" = let
    ...
    #"Filtered Rows" = Table.SelectRows(#"Changed Type", each ([Effort Management Analysis] = true)),
    #"Removed Columns" = Table.RemoveColumns(#"Filtered Rows",{"Leave Balance Analysis", "Effort Management Analysis"})
in
    #"Removed Columns";

shared Roles = let
    Source = #"LINK RoleAnalysis"
in
    Source;
...
shared Intervals = let
    ...
    #"Added ROLES" = Table.AddColumn(BUFFER, "Roles", each RolesList),
    #"Expanded Roles1" = Table.ExpandListColumn(#"Added ROLES", "Roles"),
    #"Renamed Columns1" = Table.RenameColumns(#"Expanded Roles1",{{"Roles", "Role"}}),
